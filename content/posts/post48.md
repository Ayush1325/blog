...
A [few weeks ago](@/posts/post45.md), I created a PR to update the Simplelink SDK version in [hal_ti](https://github.com/zephyrproject-rtos/hal_ti) from 4.40.04.04 to 7.41.00.17. Now that it has been merged, hopefully, I can start working on adding Bluetooth support using the BLE5 Stack in the SDK.
