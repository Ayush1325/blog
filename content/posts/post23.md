...
comment = true
+++
Hello everyone. In this post, I will go over setting up BeaglePlay and my Linux host for BeaglePlay CC1352 firmware development. Check out my [GSoC 2023 Introduction post](@/posts/post21.md) for more information about my project.
...
# Conclusion
The BeaglePlay CC1352 Firmware I am working on can be found [here](https://git.beagleboard.org/gsoc/greybus/cc1352-firmware). You can follow my GSoC23-related blog posts using this [feed](https://programmershideaway.dev/tags/gsoc23/atom.xml).
