...
![AuTerm main window at launch](/images/post68/1_Serial_OTA.webp)

2. Select BeagleConnect Freedom Port.

![Selecting the BeagleConnect Freedom port in AuTerm](/images/post68/2_Serial_OTA.webp)

3. Verify the port.

![Verifying the selected port](/images/post68/3_Serial_OTA.webp)

4. Open the Port. This will drop you into the Terminal tab. Take note of the build time.

![AuTerm Terminal tab after opening the port, showing the build time](/images/post68/4_Serial_OTA.webp)

5. Press the reset button on BeagleConnect Freedom and verify the serial output.

![Serial output after pressing the reset button on BeagleConnect Freedom](/images/post68/5_Serial_OTA.webp)

6. Rebuild the firmware as described [above](#build-zephyr-application)

7. Navigate to the MCUmgr tab.

![The MCUmgr tab in AuTerm](/images/post68/6_Serial_OTA.webp)

8. Select the newly built signed firmware.

![Selecting the newly built signed firmware](/images/post68/7_Serial_OTA.webp)

9. Switch action from Test to Confirm.

![Switching the action from Test to Confirm](/images/post68/8_Serial_OTA.webp)

10. Press the Go button to start firmware upload.

![Pressing the Go button to start the firmware upload](/images/post68/9_Serial_OTA.webp)

11. Wait for the firmware upload to finish.

![Firmware upload finished](/images/post68/10_Serial_OTA.webp)

12. Navigate to the Terminal tab to verify that the build time has changed.

![Terminal tab showing that the build time has changed](/images/post68/11_Serial_OTA.webp)
