...
# Future
During my GSoC work period, I implemented a lot more of the standard library functionality ([GSoC22 Conclusion Post](@/posts/post15.md)). So, I will work on slowly getting those parts merged. It might be slow since I do it in my free time, but feel free to help if you are interested.
