...
With the MicroPython issue and the [bricked BeagleConnect Freedom](@/posts/post35.md#support-for-more-firmware-file-types), I thought it is a good time to setup and learn Ti's [Code Composer Studio](https://www.ti.com/tool/CCSTUDIO).
