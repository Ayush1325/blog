...
[Last week](@/posts/post62.md), I introduced Zephyr SD Card images for PocketBeagle 2. These images are intended for running ZephyrRTOS on PocketBeagle 2 A53 cores instead of Linux and thus do not need rootfs. This also means that sysconf.txt based customization options are not useful for these images.
