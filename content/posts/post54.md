...
Continuing the work from [last week](@/posts/post53.md), I finished adding Python examples for all the prior Rust examples. I have also added a lot of new examples, mostly centered around the hardware available in [TechLab cape for PocketBeagle 2](https://www.beagleboard.org/boards/techlab).
